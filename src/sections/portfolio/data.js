...
import Image11 from '../../assets/project13.png'
...
const data = [
    {
        ...
        desc: "This is my first redux powerd ecommerce website to a promising herbals start up company done from the scratch using MERN stack",
        TechnicalStack:"React js,Node js,Express js,MongoDB-MERN stack",
    ...
    },
    {
        ...
        desc: "This is my personal blog website to add series of day to day experiences . Templating engine is use for dynamic rendering",
    ...
    },
    {
        ...
        category: 'frontend and backend',
        image: Image1,
        title: "Skin disease detection(frontend and backend)",
        desc: "User can upload the images of the affected area of the skin.The website uses Roboflow api to detect the skin disease-skin cancer,Eczema,acne.",
        TechnicalStack:"HTML(ejs templating engine),CSS,Node.js,Express.js",
